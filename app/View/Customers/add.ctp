...
<div class='main'>
	...
	<table>
		<tr>
			<td width="60%"><?php echo $this->Form->input('present_address', array('label' => '现在住址', 'size' => '10')); ?></td><td width="40%"></td>
		</tr>
		
		<tr>
			<td></td>
			<td align='right'><?php echo $this->Form->input('id', array('type' => 'hidden'));
