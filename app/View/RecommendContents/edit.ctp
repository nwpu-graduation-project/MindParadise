...
echo $this->Form->file('RecommendContent.picture', array('label' => '图片描述', 'required' => false));
echo $this->Form->input('RecommendContent.id', array('type' => 'hidden'));
echo $this->Form->end('保存');
?>
<div id='preview'>
	<img src=<?php echo $this->request->data['RecommendContent']['picture']; ?> id='imghead' width = 150 height=100 >
</div>
